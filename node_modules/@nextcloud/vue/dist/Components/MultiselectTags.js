 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 *
 */var u={data:function(){return{hasStatus:!1,userStatus:{status:null,message:null,icon:null}}},methods:{fetchUserStatus:function(e){var t,s=this;return(t=regeneratorRuntime.mark((function t(){var n,o,r,i,A,u,g,d,p;return regeneratorRuntime.wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(n=Object(m.getCapabilities)(),Object.prototype.hasOwnProperty.call(n,"user_status")&&n.user_status.enabled){t.next=3;break}return t.abrupt("return");case 3:if(Object(l.getCurrentUser)()){t.next=5;break}return t.abrupt("return");case 5:return t.prev=5,t.next=8,c.a.get(Object(a.generateOcsUrl)("apps/user_status/api/v1",2)+"statuses/".concat(encodeURIComponent(e)));case 8:o=t.sent,r=o.data,i=r.ocs.data,A=i.status,u=i.message,g=i.icon,s.userStatus.status=A,s.userStatus.message=u||"",s.userStatus.icon=g||"",s.hasStatus=!0,t.next=22;break;case 17:if(t.prev=17,t.t0=t.catch(5),404!==t.t0.response.status||0!==(null===(d=t.t0.response.data.ocs)||void 0===d||null===(p=d.data)||void 0===p?void 0:p.length)){t.next=21;break}return t.abrupt("return");case 21:console.error(t.t0);case 22:case"end":return t.stop()}}),t,null,[[5,17]])})),function(){var e=this,s=arguments;return new Promise((function(n,o){var r=t.apply(e,s);function i(e){A(r,n,o,i,c,"next",e)}function c(e){A(r,n,o,i,c,"throw",e)}i(void 0)}))})()}}};
/**
 ...
 *
 */
function n(e,t,s){this.r=e,this.g=t,this.b=s}function o(e,t,s){var o=[];o.push(t);for(var r=function(e,t){var s=new Array(3);return s[0]=(t[1].r-t[0].r)/e,s[1]=(t[1].g-t[0].g)/e,s[2]=(t[1].b-t[0].b)/e,s}(e,[t,s]),i=1;i<e;i++){var c=parseInt(t.r+r[0]*i,10),a=parseInt(t.g+r[1]*i,10),m=parseInt(t.b+r[2]*i,10);o.push(new n(c,a,m))}return o}t.a=function(e){e||(e=6);var t=new n(182,70,157),s=new n(221,203,85),r=new n(0,130,201),i=o(e,t,s),c=o(e,s,r),a=o(e,r,t);return i.concat(c).concat(a)}},,function(e,t){e.exports=require("core-js/modules/es.promise")},function(e,t){e.exports=require("regenerator-runtime/runtime")},,function(e,t,s){"use strict";
/**
 * @copyright Copyright (c) 2018 John Molakvoæ <skjnldsv@protonmail.com>
 *
 * @author John Molakvoæ <skjnldsv@protonmail.com>
 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 *
 */t.default=m},function(e,t,s){"use strict";s.r(t);s(25),s(48),s(80),s(11),s(86),s(117),s(118),s(108),s(21),s(105),s(81);var n=s(69);function o(e,t){var s=Object.keys(e);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);t&&(n=n.filter((function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable}))),s.push.apply(s,n)}return s}function r(e){for(var t=1;t<arguments.length;t++){var s=null!=arguments[t]?arguments[t]:{};t%2?o(Object(s),!0).forEach((function(t){i(e,t,s[t])})):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(s)):o(Object(s)).forEach((function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(s,t))}))}return e}function i(e,t,s){return t in e?Object.defineProperty(e,t,{value:s,enumerable:!0,configurable:!0,writable:!0}):e[t]=s,e}var c={name:"Highlight",props:{text:{type:String,default:""},search:{type:String,default:""},highlight:{type:Array,default:function(){return[]}}},computed:{ranges:function(){var e=this,t=[];return this.search||0!==this.highlight.length?(t=this.highlight.length>0?this.highlight:Object(n.a)(this.text,this.search),t.reduce((function(t,s){return s.start<e.text.length&&s.end>0&&t.push({start:s.start<0?0:s.start,end:s.end>e.text.length?e.text.length:s.end}),t}),[])):t},chunks:function(){if(0===this.ranges.length)return[{start:0,end:this.text.length,highlight:!1,text:this.text}];for(var e=[],t=0,s=0;t<this.text.length;){var n=this.ranges[s];n.start!==t?(e.push({start:t,end:n.start,highlight:!1,text:this.text.substr(t,n.start-t)}),t=n.start):(e.push(r(r({},n),{},{highlight:!0,text:this.text.substr(n.start,n.end-n.start)})),s++,t=n.end,s>=this.ranges.length&&t<this.text.length&&(e.push({start:t,end:this.text.length,highlight:!1,text:this.text.substr(t,this.text.length-t)}),t=this.text.length))}return e}},render:function(e){return this.ranges.length?e("span",{},this.chunks.map((function(t){return t.highlight?e("strong",{},t.text):t.text}))):e("span",{},this.text)}},a=s(0),m=s(79),l=s.n(m),A=Object(a.a)(c,void 0,void 0,!1,null,null,null);"function"==typeof l.a&&l()(A);var u=A.exports;
/**
 ...
 *
 */
Object(n.a)(o.a),t.default=o.a},,,,,,,,,,,,,,function(e,t,s){"use strict";var n=s(75);s.n(n).a},function(e,t,s){(t=s(1)(!1)).push([e.i,".option[data-v-01dee904]{display:flex;align-items:center;width:100%;height:32px}.option__avatar[data-v-01dee904]{flex:0 0 32px;width:32px;height:32px;margin-right:6px}.option__desc[data-v-01dee904]{display:flex;flex:1 1;flex-direction:column;justify-content:center;min-width:0}.option__desc--lineone[data-v-01dee904]{color:var(--color-text-light)}.option__desc--linetwo[data-v-01dee904]{opacity:.7}.option__desc--lineone[data-v-01dee904],.option__desc--linetwo[data-v-01dee904]{overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.option__desc--lineone strong[data-v-01dee904],.option__desc--linetwo strong[data-v-01dee904]{font-weight:bold}.option__icon[data-v-01dee904]{flex:0 0 44px;width:44px;height:44px;margin:-6px;opacity:.5;background-position:center;background-size:16px}\n",""]),e.exports=t},function(e,t){e.exports=require("core-js/modules/es.string.split")},function(e,t,s){"use strict";var n=s(76);s.n(n).a},function(e,t,s){(t=s(1)(!1)).push([e.i,".name-parts[data-v-f855c4b8]{display:flex;max-width:100%}.name-parts__first[data-v-f855c4b8]{overflow:hidden;text-overflow:ellipsis}.name-parts__first[data-v-f855c4b8],.name-parts__last[data-v-f855c4b8]{white-space:pre}.name-parts__first strong[data-v-f855c4b8],.name-parts__last strong[data-v-f855c4b8]{font-weight:bold}\n",""]),e.exports=t},,,,,,,,,,,,,function(e,t){},,,,,,,,,,,,,,,,,,function(e,t,s){var n=s(198);"string"==typeof n&&(n=[[e.i,n,""]]),n.locals&&(e.exports=n.locals);(0,s(2).default)("b5985a26",n,!0,{})},function(e,t,s){(t=s(1)(!1)).push([e.i,".multiselect[data-v-19787a9]{margin:0;padding:0 !important;display:inline-block;min-width:160px;position:relative;background-color:var(--color-main-background)}.multiselect[data-v-19787a9]:not(.multiselect--active) .multiselect__single{position:absolute;width:100%}.multiselect[data-v-19787a9].multiselect--active input.multiselect__input{opacity:1 !important;cursor:text !important;border-radius:var(--border-radius) var(--border-radius) 0 0}.multiselect[data-v-19787a9].multiselect--active .multiselect__limit{display:none}.multiselect[data-v-19787a9].multiselect--active.multiselect--above input.multiselect__input{border-radius:0 0 var(--border-radius) var(--border-radius)}.multiselect[data-v-19787a9].multiselect--disabled,.multiselect[data-v-19787a9].multiselect--disabled .multiselect__single{background-color:var(--color-background-dark) !important}.multiselect[data-v-19787a9].icon-loading-small::after{left:100%;margin-left:-24px}.multiselect[data-v-19787a9] .multiselect__tags{display:flex;flex-wrap:nowrap;overflow:hidden;border:1px solid var(--color-border-dark);cursor:pointer;position:relative;border-radius:3px;height:34px}.multiselect[data-v-19787a9] .multiselect__tags .multiselect__tags-wrap{align-items:center;display:inline-flex;overflow:hidden;max-width:100%;position:relative;padding:3px 5px;flex-grow:1}.multiselect[data-v-19787a9] .multiselect__tags .multiselect__tags-wrap:empty ~ input.multiselect__input{opacity:1 !important}.multiselect[data-v-19787a9] .multiselect__tags .multiselect__tags-wrap:empty ~ input.multiselect__input+span:not(.multiselect__single){display:none}.multiselect[data-v-19787a9] .multiselect__tags .multiselect__tags-wrap .multiselect__tag{flex:1 0 0;line-height:20px;padding:1px 5px;background-image:none;color:var(--color-main-text);border:1px solid var(--color-border-dark);display:inline-flex;align-items:center;border-radius:3px;min-width:0;max-width:50%;max-width:fit-content;max-width:-moz-fit-content}.multiselect[data-v-19787a9] .multiselect__tags .multiselect__tags-wrap .multiselect__tag:only-child{flex:0 1 auto}.multiselect[data-v-19787a9] .multiselect__tags .multiselect__tags-wrap .multiselect__tag:not(:last-child){margin-right:5px}.multiselect[data-v-19787a9] .multiselect__tags .multiselect__tags-wrap .multiselect__tag>span{white-space:nowrap;text-overflow:ellipsis;overflow:hidden}.multiselect[data-v-19787a9] .multiselect__tags .multiselect__single,.multiselect[data-v-19787a9] .multiselect__tags .multiselect__placeholder{padding:7px 6px;flex:0 0 100%;z-index:1;background-color:var(--color-main-background);cursor:pointer;line-height:18px;color:var(--color-text-lighter)}.multiselect[data-v-19787a9] .multiselect__tags .multiselect__strong,.multiselect[data-v-19787a9] .multiselect__tags .multiselect__limit{flex:0 0 auto;line-height:20px;color:var(--color-text-lighter);display:inline-flex;align-items:center;opacity:.7;margin-right:5px;z-index:5}.multiselect[data-v-19787a9] .multiselect__tags input.multiselect__input{width:100% !important;position:absolute !important;top:0;left:0;margin:0;opacity:0;height:100%;border:none;display:block !important;cursor:pointer;padding:7px 6px !important}.multiselect[data-v-19787a9] .multiselect__content-wrapper{position:absolute;width:100%;margin-top:-1px;border:1px solid var(--color-border-dark);background:var(--color-main-background);z-index:50;max-height:250px;overflow-y:auto;border-radius:0 0 var(--border-radius) var(--border-radius)}.multiselect[data-v-19787a9] .multiselect__content-wrapper .multiselect__content{width:100%;padding:0}.multiselect[data-v-19787a9] .multiselect__content-wrapper li{position:relative;display:flex;align-items:center;background-color:transparent}.multiselect[data-v-19787a9] .multiselect__content-wrapper li,.multiselect[data-v-19787a9] .multiselect__content-wrapper li span{cursor:pointer}.multiselect[data-v-19787a9] .multiselect__content-wrapper li>span{padding:8px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin:0;height:auto;min-height:1em;-webkit-touch-callout:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;display:inline-flex;align-items:center;background-color:transparent;color:var(--color-text-lighter);width:100%}.multiselect[data-v-19787a9] .multiselect__content-wrapper li>span::before{content:' ';background-repeat:no-repeat;background-position:center;min-width:16px;min-height:16px;display:block;opacity:.5;margin-right:5px;visibility:hidden}.multiselect[data-v-19787a9] .multiselect__content-wrapper li>span.multiselect__option--disabled{background-color:var(--color-background-dark);opacity:.5}.multiselect[data-v-19787a9] .multiselect__content-wrapper li>span.multiselect__option--highlight{color:var(--color-main-text);background-color:var(--color-background-dark)}.multiselect[data-v-19787a9] .multiselect__content-wrapper li>span:not(.multiselect__option--disabled):hover::before{opacity:.3}.multiselect[data-v-19787a9] .multiselect__content-wrapper li>span.multiselect__option--selected::before,.multiselect[data-v-19787a9] .multiselect__content-wrapper li>span:not(.multiselect__option--disabled):hover::before{visibility:visible}.multiselect[data-v-19787a9].multiselect--above .multiselect__content-wrapper{bottom:100%;margin-bottom:-1px}.multiselect[data-v-19787a9].multiselect--multiple .multiselect__content-wrapper li>span::before{background-image:var(--icon-checkmark-000)}.multiselect[data-v-19787a9].multiselect--multiple .multiselect__content-wrapper li>span[data-select='create']::before{background-image:var(--icon-add-000);visibility:visible}.multiselect[data-v-19787a9].multiselect--single .multiselect__content-wrapper li>span::before{display:none}.multiselect[data-v-19787a9]:hover .multiselect__placeholder,.multiselect[data-v-19787a9] input.multiselect__input .multiselect__placeholder{color:var(--color-main-text)}\n",""]),e.exports=t},,,,,function(e,t,s){"use strict";s.r(t);s(48),s(279),s(11),s(30),s(3),s(60),s(61);var n=s(35),o=s(148),r=s(40),i=s.n(r),c=s(29);function a(e,t,s,n,o,r,i){try{var c=e[r](i),a=c.value}catch(e){return void s(e)}c.done?t(a):Promise.resolve(a).then(n,o)}
/**
 * @copyright Copyright (c) 2019 Julius Härtl <jus@bitgrid.net>
 *
 * @author Julius Härtl <jus@bitgrid.net>
 ...
 *
 */
var m=function(e){var t=function e(t){var s={};if(1===t.nodeType){if(t.attributes.length>0){s["@attributes"]={};for(var n=0;n<t.attributes.length;n++){var o=t.attributes.item(n);s["@attributes"][o.nodeName]=o.nodeValue}}}else 3===t.nodeType&&(s=t.nodeValue);if(t.hasChildNodes())for(var r=0;r<t.childNodes.length;r++){var i=t.childNodes.item(r),c=i.nodeName;if(void 0===s[c])s[c]=e(i);else{if(void 0===s[c].push){var a=s[c];s[c]=[],s[c].push(a)}s[c].push(e(i))}}return s}(function(e){var t=null;try{t=(new DOMParser).parseFromString(e,"text/xml")}catch(e){console.error("Failed to parse xml document",e)}return t}(e))["d:multistatus"]["d:response"],s=[];for(var n in t){var o=t[n]["d:propstat"];"HTTP/1.1 200 OK"===o["d:status"]["#text"]&&s.push({id:parseInt(o["d:prop"]["oc:id"]["#text"]),displayName:o["d:prop"]["oc:display-name"]["#text"],canAssign:"true"===o["d:prop"]["oc:can-assign"]["#text"],userAssignable:"true"===o["d:prop"]["oc:user-assignable"]["#text"],userVisible:"true"===o["d:prop"]["oc:user-visible"]["#text"]})}return s},l=function(){var e,t=(e=regeneratorRuntime.mark((function e(){var t;return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(!window.NextcloudVueDocs){e.next=2;break}return e.abrupt("return",Promise.resolve(m(window.NextcloudVueDocs.tags)));case 2:return e.next=4,i()({method:"PROPFIND",url:Object(c.generateRemoteUrl)("dav")+"/systemtags/",data:'<?xml version="1.0"?>\n\t\t\t\t\t<d:propfind  xmlns:d="DAV:" xmlns:oc="http://owncloud.org/ns">\n\t\t\t\t\t  <d:prop>\n\t\t\t\t\t\t<oc:id />\n\t\t\t\t\t\t<oc:display-name />\n\t\t\t\t\t\t<oc:user-visible />\n\t\t\t\t\t\t<oc:user-assignable />\n\t\t\t\t\t\t<oc:can-assign />\n\t\t\t\t\t  </d:prop>\n\t\t\t\t\t</d:propfind>'});case 4:return t=e.sent,e.abrupt("return",m(t.data));case 6:case"end":return e.stop()}}),e)})),function(){var t=this,s=arguments;return new Promise((function(n,o){var r=e.apply(t,s);function i(e){a(r,n,o,i,c,"next",e)}function c(e){a(r,n,o,i,c,"throw",e)}i(void 0)}))});return function(){return t.apply(this,arguments)}}(),A=s(6);function u(e,t,s,n,o,r,i){try{var c=e[r](i),a=c.value}catch(e){return void s(e)}c.done?t(a):Promise.resolve(a).then(n,o)}var g={name:"MultiselectTags",components:{Multiselect:o.default},mixins:[n.a],props:{label:{type:String,default:Object(A.b)("Select a tag")},value:{type:[Number,Array],required:!0},disabled:{type:Boolean,default:!1},multiple:{type:Boolean,default:!0}},data:function(){return{tags:[]}},computed:{inputValue:function(){return this.getValueObject()}},beforeCreate:function(){var e,t=this;return(e=regeneratorRuntime.mark((function e(){var s;return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=0,e.next=3,l();case 3:s=e.sent,t.tags=s,e.next=10;break;case 7:e.prev=7,e.t0=e.catch(0),console.error("Loading systemtags failed",e.t0);case 10:case"end":return e.stop()}}),e,null,[[0,7]])})),function(){var t=this,s=arguments;return new Promise((function(n,o){var r=e.apply(t,s);function i(e){u(r,n,o,i,c,"next",e)}function c(e){u(r,n,o,i,c,"throw",e)}i(void 0)}))})()},methods:{getValueObject:function(){var e=this;return 0===this.tags.length?[]:this.multiple?this.value.filter((function(e){return""!==e})).map((function(t){return e.tags.find((function(e){return e.id===t}))})):this.tags.find((function(t){return t.id===e.value}))},update:function(e){this.multiple?this.$emit("input",e.map((function(e){return e.id}))):null===e?this.$emit("input",null):this.$emit("input",e.id)},tagLabel:function(e){var t=e.displayName,s=e.userVisible,n=e.userAssignable;return!1===s?Object(A.b)("{tag} (invisible)",{tag:t}):!1===n?Object(A.b)("{tag} (restricted)",{tag:t}):t}}},d=s(0),p=s(179),v=s.n(p),f=Object(d.a)(g,(function(){var e=this,t=e.$createElement,s=e._self._c||t;return s("Multiselect",{attrs:{value:e.inputValue,options:e.tags,"options-limit":5,placeholder:e.label,"track-by":"id","custom-label":e.tagLabel,multiple:e.multiple,"close-on-select":e.multiple,"tag-width":60,disabled:e.disabled},on:{input:e.update},scopedSlots:e._u([{key:"option",fn:function(t){return[e._v("\n\t\t"+e._s(e.tagLabel(t.option))+"\n\t")]}}])},[s("span",{attrs:{slot:"noResult"},slot:"noResult"},[e._v(e._s(e.t("No results")))])])}),[],!1,null,null,null);"function"==typeof v.a&&v()(f);var h=f.exports;
/**
 * @copyright Copyright (c) 2019 John Molakvoæ <skjnldsv@protonmail.com>
 *
 * @author John Molakvoæ <skjnldsv@protonmail.com>
 ...
 * You should have received a copy of the GNU Affero General Public License
 * along with this program.  If not, see <http://www.gnu.org/licenses/>.
 */t.default=h},,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,function(e,t){e.exports=require("core-js/modules/es.array.find")}])}));
//# sourceMappingURL=MultiselectTags.js.map